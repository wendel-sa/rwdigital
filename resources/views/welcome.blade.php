...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">R&W Digital</a></h1>
      ...
      <div class="social-links">
        ...
        <a href="https://www.instagram.com/rewdigitalpnz/" target="_blank" class="nav-link scrollto"><i class="bi bi-instagram"></i></a>
      </div>
    ...
    <div class="container d-flex h-100">
      <div class="row justify-content-center align-self-center" data-aos="fade-up">
        <div class="col-lg-6 intro-info order-lg-first order-last" data-aos="zoom-in" data-aos-delay="100">
          <h2>Soluções para<br> o seu <span>Negócio!</span></h2>
          <div>
  ...
  <main id="main">
        ...
        <div class="">
          ...
          <div class="">
            <div class="about-content" data-aos="fade-left" data-aos-delay="100">
              <h2>Sobre nós</h2>
              <h3>Somos uma empresa recém constuida porém com uma longa bagagem de atuação na área de desenvolvimento.
              </h3>
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          <h3>Serviços</h3>
          <p>Formas que podemos melhorar sua empresa.</p>
        </header>
        ...
        <div class="row g-5">
          ...
          <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="200" ">
        <div class=" box ">
            <div class=" icon " style=" background: #e1eeff; "><i class=" bi bi-brightness-high " style=" color:
            #2282ff; "></i>
            </div>
        ...
        <div class=" col-md-6 col-lg-4 " data-aos=" zoom-in " data-aos-delay=" 300 ">
          <div class=" box ">
            <div class=" icon " style=" background: #ecebff; "><i class=" bi bi-calendar4-week " style=" color:
            #8660fe; "></i>
            </div>
    ...
    <section id=" features " class=" features ">
      <div class=" container " data-aos=" fade-up ">
        ...
        <div class=" row feature-item mt-5 pt-5 ">
          ...
          <div class=" col-lg-6 wow fadeInUp pt-4 pt-lg-0 order-2 order-lg-1 " data-aos=" fade-right " data-aos-delay="
            150 ">
    ...
    <section id="portfolio" class=" portfolio section-bg ">
      <div class="container" data-aos=" fade-up ">
        ...
        <header class="section-header ">
          <h3 class="section-title">Nosso Portifólio</h3>
        </header>
        ...
        <div class="row" data-aos="fade-up" data-aos-delay=" 100 ">
          <div class="col-lg-12">
            <ul id="portfolio-flters">
              ...
              <li data-filter=" .filter-web ">Sistemas Web</li>
            </ul>
          </div>
        </div>
